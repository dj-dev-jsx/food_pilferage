...
<head>
    ...
    <title>Food Pilferage Management - Inventory Logs</title>
...
<body>
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <select class="form-select" id="actionFilter">
                                    ...
                                    <option value="NEW_ITEM_ADDED">Added</option>
                                    <option value="STOCK_UPDATED">Updated</option>
    ...
    <script src="js/inventory_logs.js"></script>
